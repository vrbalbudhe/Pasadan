  ...
  return (
    <div className="w-full h-full flex flex-col justify-center items-center">
      ...
      <div className="w-full h-10 mb-10 flex justify-center items-center cursor-pointer">
        <p className="w-full flex h-fit justify-center items-center">
      ...
      <section 
      className="w-full h-full pb-20 flex flex-col justify-center items-center">
        <div
