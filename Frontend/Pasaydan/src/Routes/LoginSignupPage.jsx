          ...
          {isLogin ? (
            <>
              ...
              <form>
                ...
                <button className="w-full bg-black text-white py-2 rounded-lg hover:bg-gray-800 transition-all duration-200">
                  Log In
                </button>
              </form>
            ...
            <>
              ...
              <form>
                ...
                <button className="w-full bg-green-500 text-white py-2 rounded-lg hover:bg-green-600 transition-all duration-200">
                  Sign Up
                </button>
              </form>
              <p className="text-center mt-4 text-gray-500">
