...
const Vision = () => {
  return (
    <div 
    className="flex flex-col justify-center items-center py-14 bg-[#f8f7ff]">
      {/* Heading */}
      ...
      <div className="flex justify-center items-center space-x-8">
        ...
        <div className="group w-96 h-60 [perspective:1000px]">
          <div className="relative w-full h-full transition-transform duration-1000 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
            {/* Front Side */}
            <div className="absolute inset-0 bg-siteBlue rounded-lg text-white flex items-center justify-center text-2xl font-semibold [backface-visibility:hidden]">
              VISION
            </div>
            {/* Back Side */}
            <div className="absolute inset-0 bg-white text-siteBlue border-2 shadow-md rounded-lg p-6 flex flex-col items-center justify-center [transform:rotateY(180deg)] [backface-visibility:hidden]">
              <FaQuoteLeft className="text-3xl text-siteBlue mb-2" />
